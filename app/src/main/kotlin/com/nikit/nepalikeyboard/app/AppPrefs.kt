...
import com.nikit.nepalikeyboard.app.settings.theme.ColorPreferenceSerializer
...
import com.nikit.nepalikeyboard.ime.input.CapitalizationBehavior
import com.nikit.nepalikeyboard.ime.input.HapticVibrationMode
import com.nikit.nepalikeyboard.ime.input.InputFeedbackActivationMode
import com.nikit.nepalikeyboard.ime.keyboard.IncognitoMode
import com.nikit.nepalikeyboard.ime.keyboard.SpaceBarMode
import com.nikit.nepalikeyboard.ime.landscapeinput.LandscapeInputUiMode
import com.nikit.nepalikeyboard.ime.media.emoji.EmojiHairStyle
import com.nikit.nepalikeyboard.ime.media.emoji.EmojiHistory
import com.nikit.nepalikeyboard.ime.media.emoji.EmojiSkinTone
import com.nikit.nepalikeyboard.ime.media.emoji.EmojiSuggestionType
import com.nikit.nepalikeyboard.ime.nlp.SpellingLanguageMode
import com.nikit.nepalikeyboard.ime.smartbar.CandidatesDisplayMode
import com.nikit.nepalikeyboard.ime.smartbar.ExtendedActionsPlacement
import com.nikit.nepalikeyboard.ime.smartbar.IncognitoDisplayMode
import com.nikit.nepalikeyboard.ime.smartbar.SmartbarLayout
import com.nikit.nepalikeyboard.ime.smartbar.quickaction.QuickAction
import com.nikit.nepalikeyboard.ime.smartbar.quickaction.QuickActionArrangement
import com.nikit.nepalikeyboard.ime.smartbar.quickaction.QuickActionJsonConfig
import com.nikit.nepalikeyboard.ime.text.gestures.SwipeAction
import com.nikit.nepalikeyboard.ime.text.key.KeyCode
import com.nikit.nepalikeyboard.ime.text.key.KeyHintConfiguration
...
import com.nikit.nepalikeyboard.ime.theme.extCoreTheme
import com.nikit.nepalikeyboard.ime.window.ImeWindowConfig
import com.nikit.nepalikeyboard.lib.ext.ExtensionComponentName
import com.nikit.nepalikeyboard.lib.util.VersionName
...
abstract class FlorisPreferenceModel : PreferenceModel() {
    ...
    inner class GeminiVoice {
        ...
        // No model setting: Transcribe always uses gemini-3.5-transcribe-live and
        // Translate always uses gemini-3.5-live-translate-preview (see
        // GeminiLiveVoiceManager.modelFor). The user only configures an API key.
        val mode = enum(
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    com.nikit.nepalikeyboard.ime.media.emoji.Emoji(it, "", emptyList())
                }
