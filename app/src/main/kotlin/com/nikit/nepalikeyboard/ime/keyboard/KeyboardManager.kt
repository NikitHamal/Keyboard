...
package com.nikit.nepalikeyboard.ime.keyboard
...
import com.nikit.nepalikeyboard.appContext
...
import com.nikit.nepalikeyboard.ime.core.SubtypePreset
import com.nikit.nepalikeyboard.ime.editor.EditorContent
import com.nikit.nepalikeyboard.ime.editor.FlorisEditorInfo
import com.nikit.nepalikeyboard.ime.editor.ImeOptions
import com.nikit.nepalikeyboard.ime.editor.InputAttributes
import com.nikit.nepalikeyboard.ime.editor.OperationUnit
import com.nikit.nepalikeyboard.ime.input.CapitalizationBehavior
import com.nikit.nepalikeyboard.ime.input.InputEventDispatcher
import com.nikit.nepalikeyboard.ime.input.InputKeyEventReceiver
import com.nikit.nepalikeyboard.ime.input.InputShiftState
import com.nikit.nepalikeyboard.ime.nlp.ClipboardSuggestionCandidate
import com.nikit.nepalikeyboard.ime.nlp.PunctuationRule
import com.nikit.nepalikeyboard.ime.nlp.SuggestionCandidate
import com.nikit.nepalikeyboard.ime.popup.PopupMappingComponent
...
import com.nikit.nepalikeyboard.ime.text.keyboard.TextKeyboardCache
import com.nikit.nepalikeyboard.lib.devtools.LogTopic
import com.nikit.nepalikeyboard.lib.devtools.flogError
import com.nikit.nepalikeyboard.lib.ext.ExtensionComponentName
import com.nikit.nepalikeyboard.lib.titlecase
import com.nikit.nepalikeyboard.lib.uppercase
import com.nikit.nepalikeyboard.lib.util.InputMethodUtils
import com.nikit.nepalikeyboard.nlpManager
...
class KeyboardManager(context: Context) : InputKeyEventReceiver {
    ...
    override fun onInputKeyUp(data: KeyData) = activeState.batchEdit {
        ...
        when (data.code) {
            ...
            KeyCode.VOICE_INPUT -> {
                activeState.imeUiMode = if (activeState.imeUiMode == ImeUiMode.VOICE) {
                    ImeUiMode.TEXT
                } else {
                    ImeUiMode.VOICE
                }
